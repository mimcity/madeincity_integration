  ...
  return (
    <Layout fullWidth={true}>
      <div className="sm:h-screen relative flex sm:mt-0 mt-[87px]">
        ...
        />
        <div className="z-50 relative flex-1 flex flex-col justify-center xl:max-w-screen-2xl mx-auto lg:px-15 md:px-8 px-4">
          <div className="flex flex-col justify-between flex-1 sm:pb-9">
            <div></div>
            <div>
